...
(function (Sample) {
    function calcTemplate(data) {
        return Wfx.element('div', { data: data }, Wfx.element('button', { 'class': "btn",
            'click': function (_) { return _.decrease(); }, data: data }, "-"), Wfx.element('span', { 'text': Wfx.bind(function (_) { return _.value; }), data: data }), Wfx.element('button', { 'class': "btn",
            'click': function (_) { return _.increase(); }, data: data }, "+"));
    }
